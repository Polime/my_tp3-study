...
<html>
  ...
  <body>
    ...
    <!-- <table border="1" width="500px"> -->
      <!-- <?php $__FOR_START_1957957368__=0;$__FOR_END_1957957368__=10;for($j=$__FOR_START_1957957368__;$j < $__FOR_END_1957957368__;$j+=2){ ?><tr>
          <td>
            <?php echo ($j); ?> <! 默认$i为循环数,name改变循环数的名字 -->
          <!-- </td>
          <td>abc</td>
        </tr><?php } ?>
      <?php $__FOR_START_656778275__=10;$__FOR_END_656778275__=0;for($i=$__FOR_START_656778275__;$i > $__FOR_END_656778275__;$i+=-2){ ?><! 倒序输出 -->
        <!-- <tr>
          <td>
            <?php echo ($i); ?>
          </td>
